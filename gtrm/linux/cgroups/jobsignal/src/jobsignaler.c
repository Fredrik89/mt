...
// ****************************************************************************
// Registers the application calling this function
_application_h* jobsignaler_registration() {
  ...
  // present, the call terminates the application to avoid se(g)mentation
  // faults
  ...
  // generates key to id our app
  // allocate shared memory segment
  // attach sh.mem. to the calling process address space
