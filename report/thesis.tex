...
and~\ref{eq:servicelevelnotsimple}.
...
\section{manager.c}
Note that this file is a part of \texttt{systemd} and only what was added or changed to this file is included in the following code-snippets. For the rest of the code in this file, please refer to the open-source project ~\cite{sysd}.
