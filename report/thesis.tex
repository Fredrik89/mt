...
The test-application is shown below to give an idea about how an application can implement the SL adaptation and what functions that are provided by \emph{gtrm_app_lib.c}.
