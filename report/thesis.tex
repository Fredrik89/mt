...
\fixed{Look at the next paragraph. You will need to add something like
...
\fixed{Comment here: are the virtual platform assignments respecting
...
\fixed{Include in the figure for the virtual platform 0.2 in the
...
\fixed{When you comment it, say that the service level shown in the
...
=======
>>>>>>> 745116bfc0b3cb4a8c0b859a09a5ac3a01f5c16c
\section{Conclusion}
