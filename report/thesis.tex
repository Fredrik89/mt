...
To test the system, several applications are ran with different parameters, according to two different test sequences.
...
\subsection{Test 1}
The first test uses the following applications.
