...
\martina{Describe a little bit better the example that you are giving.
  Maybe complete the numerical example -- since you already have part of
  if in Figure~\ref{fig:ctable} and the ``third'' in the text -- of what 
  you would give to each of the slices and to each of the services inside
  the slices and how would the CPU behave. What do the number in the 
  table mean? And, if you are in a multicore environment, what happens
