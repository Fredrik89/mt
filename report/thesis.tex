...
\begin{verbatim}
- change get_epsilon()
- change compute_virtual
- mention irregular update times in GTRM
- mention solution to ^ in future work
- replace all ???
\end{verbatim}
...
work, a GTRM-like approach is implemented to be \textcolor{red}{???} applicable to Axis cameras.
